                ...
                <Grid item xs={12} md={4} sx={{marginTop: '6px'}}>
                  <FormControl fullWidth>
                    <Controller
                      name='services'
                      control={control}
                      render={({field: {value, onChange}}) => <TextField label='Servicios' value={value} onChange={onChange} />}
                    />
                  </FormControl>
                </Grid>
                <Grid item xs={12} md={6} sx={{marginTop: '6px'}}>
                  <FormControl fullWidth>
                    <Controller
                      name='motive'
                      control={control}
                      render={({field: {value, onChange}}) => <TextField label='Motivo' value={value} onChange={onChange} />}
                    />
                  </FormControl>
                </Grid>
                <Grid item xs={12} md={6} sx={{marginTop: '6px'}}>
                  <FormControl fullWidth>
                    <Controller
                      name='provider'
                      control={control}
                      render={({field: {value, onChange}}) => <TextField label='Proveedor' value={value} onChange={onChange} />}
                    />
                  </FormControl>
                </Grid>
                <Grid item xs={12} md={6} sx={{marginTop: '6px'}}>
                  <FormControl fullWidth>
                    <Controller
                      name='materials'
                      control={control}
                      render={({field: {value, onChange}}) => <TextField label='Materiales' value={value} onChange={onChange} />}
                    />
                  </FormControl>
                </Grid>
                <Grid item xs={12} md={6} sx={{marginTop: '6px'}}>
